      ...
      <v-col sm="10" class="mx-auto">
        <v-card class="pa-5">
          ...
          <v-form ref="form" @submit.prevent="submitForm" class="pa-5" enctype="multipart/form-data">
            ...
            <v-file-input @change="selectFile" :rules="rules" show-size counter multiple label="Image"></v-file-input>
            <v-btn type="submit" class="mt-6" color="primary">Add post to blog</v-btn>
          </v-form>
        </v-card>
      </v-col>
    </v-row>
